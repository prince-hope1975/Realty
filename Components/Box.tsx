...
const Box = (props:PropsWithChildren &{ img: string, price: number, time_in_secs: number, desc: string, owner:string}) => {
   ...
   return (
    <div  {...props}  className={styles.box}>
      ...
      <div className={styles.desc}>
        ...
        <div className={styles.secondary_area}><span>Ends in</span> {hours}h  {minutes}m  {seconds}s</div>
        <div className={styles.secondary_area}><span>Current Bid</span> {price} Algo</div>
